...
class ReadingListModel: ObservableObject {
    ...
    /// Adds a document to the books collection in the Firestore database
    ///
    /// Parameters:
    ...
    func addBook(book: Book) {
        ...
        // Create the books collection if it doesn't already exist
        let books = db.collection("books")
        
        // Create a book document with the given book parameter
    ...
    func deleteBook(book: Book) {
        ...
        // Reference to the given book document by ID
    ...
    func updateBookData(book: Book) {
        ...
        // Update the book status, rating, and genre data
